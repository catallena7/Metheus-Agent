...
sub main(){
	...
	foreach my $line (@STDOUT_LINES){
		...
		if ($NoOfProcess> 15000){
			print ("ERROR_CODE::NOP000,,SEVERITY::FATAL,,MESSAGE::No of Process is $NoOfProcess\n");
		}elsif ($NoOfProcess> 10000){
			print ("ERROR_CODE::NOP001,,SEVERITY::ERROR,,MESSAGE::No of Process is $NoOfProcess\n");
		}elsif ($NoOfProcess> 3000){
			print ("ERROR_CODE::NOP002,,SEVERITY::WARN,,MESSAGE::No of Process is $NoOfProcess\n");
		}
		my $key;
		my $value;
		my $outStr;
